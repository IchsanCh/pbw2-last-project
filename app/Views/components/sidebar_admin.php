...
<aside class="w-64 min-h-full bg-base-100 border-r flex flex-col">
    ...
    <ul class="menu p-4 gap-1 flex-1">
        ...
        <?php if ($role === 'pemilik'): ?>
            ...
            <li class="pl-4">
                <a href="<?= base_url('penjualan/edit') ?>" class="<?= $uri === 'penjualan/edit' ? 'active font-bold text-white' : 'text-black hover:bg-black hover:text-white hover:font-semibold' ?>">Penjualan</a>
            </li>
            <li class="pl-4">
            ...
            <li class="pl-4">
                <a href="<?= base_url('laporan/penjualan') ?>" class="<?= $uri === 'laporan/penjualan' ? 'active font-bold text-white' : 'text-black hover:bg-black hover:text-white hover:font-semibold' ?>">Penjualan</a>
            </li>
            <li class="pl-4">
                <a href="<?= base_url('laporan/pembelian') ?>" class="<?= $uri === 'laporan/pembelian' ? 'active font-bold text-white' : 'text-black hover:bg-black hover:text-white hover:font-semibold' ?>">Pembelian</a>
            </li>
        <?php endif; ?>
        <?php if ($role === 'kasir'): ?>
